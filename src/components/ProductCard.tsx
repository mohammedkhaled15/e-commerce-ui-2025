          ...
          <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center gap-2">
                {product.colors.map((color)=>(
                  <div 
                    className={`cursor-pointer border-1 rounded-full p-[1.2px] ${productTypes.color === color ? "border-gray-400" : "border-gray-200"} w-6 h-6 flex items-center justify-center rounded-full`} 
                    key={color} 
